                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group row mb-4" id="form_resize">
                                                            ...
                                                            <div class="col-md-3">
                                                            <select id="deinterlancing" name="deinterlancing" class="form-control" data-toggle="select2">
                                                                    <?php foreach (array("0" => "Weave deinterlacing (do nothing)", "1" => "Bob deinterlacing", "2" => "Adaptive deinterlacing") as $rCodec => $rCodecName) {?>
                                                                    <option <?php if ((isset($rProfileArr)) && ($rProfileOptions["-deint"] == $rCodec)) {echo "selected ";}?>value="<?=$rCodec?>"><?=$rCodecName?></option>
                                                                    <?php }?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-md-3">
                                                                <select id="video_codec" name="video_codec" class="form-control" data-toggle="select2">
                                                                    <?php foreach (array("copy" => "Copy Codec (Associated Transcoding Options Will not work)", "apng" => "APNG (Animated Portable Network Graphics) image", "cavs" => "Chinese AVS (Audio Video Standard) (AVS1-P2, JiZhun profile) (encoders: libxavs)", "cinepak" => "Cinepak", "ffv1" => "FFmpeg video codec #1", "flashsv" => "Flash Screen Video v1", "flashsv2" => "Flash Screen Video v2", "flv1" => "FLV / Sorenson Spark / Sorenson H.263 (Flash Video) (decoders: flv) (encoders: flv)", "gif" => "GIF (Graphics Interchange Format)", "h261" => "H.261", "h263" => "H.263 / H.263-1996, H.263+ / H.263-1998 / H.263 version 2", "h263p" => "H.263+ / H.263-1998 / H.263 version 2", "h264" => "H.264 / AVC / MPEG-4 AVC / MPEG-4 part 10 (encoders: libx264 libx264rgb)", "h264_nvenc" => "GPU H.264 / AVC / MPEG-4 AVC / MPEG-4 part 10 (encoders: libx264)", "hevc" => "H.265 / HEVC (High Efficiency Video Coding) (encoders: libx265)", "hevc_nvenc" => "GPU H.265 / HEVC (High Efficiency Video Coding) (encoders: libx265)", "mpeg1video" => "MPEG-1 video", "mpeg2video" => "MPEG-2 video (decoders: mpeg2video mpegvideo)", "mpeg4" => "MPEG-4 part 2 (encoders: mpeg4 libxvid)", "msmpeg4v2" => "MPEG-4 part 2 Microsoft variant version 2", "msmpeg4v3" => "MPEG-4 part 2 Microsoft variant version 3 (decoders: msmpeg4) (encoders: msmpeg4)", "msvideo1" => "Microsoft Video 1", "png" => "PNG (Portable Network Graphics) image", "qtrle" => "QuickTime Animation (RLE) video", "roq" => "id RoQ video (decoders: roqvideo) (encoders: roqvideo)", "rv10" => "RealVideo 1.0", "rv20" => "RealVideo 2.0", "snow" => "Snow", "svq1" => "Sorenson Vector Quantizer 1 / Sorenson Video 1 / SVQ1", "theora" => "Theora (encoders: libtheora)", "vp8" => "On2 VP8 (decoders: vp8 libvpx) (encoders: libvpx)", "vp9" => "Google VP9 (decoders: vp9 libvpx-vp9) (encoders: libvpx-vp9)", "wmv1" => "Windows Media Video 7", "wmv2" => "Windows Media Video 8", "zmbv" => "Zip Motion Blocks Video") as $rCodec => $rCodecName) {?>
                                                        ...
                                                        <!-- <div class="form-group row mb-4" id="form_cdeint">
                                                            <label class="col-md-3 col-form-label" for="logo_path"><?=$_["logo_path_url"]?> <i data-toggle="tooltip" data-placement="top" title="" data-original-title="<?=$_["profile_tooltip_16"]?>" class="mdi mdi-information"></i></label>
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" id="logo_path" name="logo_path" value="<?php if (isset($rProfileArr)) {echo htmlspecialchars($rProfileOptions["16"]["val"]);}?>">
                                                            </div>
