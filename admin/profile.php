                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <label class="col-md-3 col-form-label" for="use_cuvid"><?=$_["use_cuvid"]?></label>
                                                            <div class="col-md-3">
                                                            <select id="use_cuvid" name="use_cuvid" class="form-control" data-toggle="select2">
                                                                    <?php foreach (Array("0" => "Do not use GPU Encoding", "1" => "H.264 NVENC Decoding", "2" => "H.265 / HVEC NVENC Decoding") as $rCodec => $rCodecName) { ?>
                                                                    <option <?php if ((isset($rProfileArr)) && ($rProfileOptions["use_cuvid"] == $rCodec)) { echo "selected "; } ?>value="<?=$rCodec?>"><?=$rCodecName?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <div class="col-md-3">
                                                                <select id="video_codec" name="video_codec" class="form-control" data-toggle="select2">
                                                                    ...
                                                                    <option <?php if ((isset($rProfileArr)) && ($rProfileOptions["-vcodec"] == $rCodec)) { echo "selected "; } ?>value="<?=$rCodec?>"><?=$rCodecName?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <select id="audio_codec" name="audio_codec" class="form-control" data-toggle="select2">
                                                                    ...
                                                                    <option <?php if ((isset($rProfileArr)) && ($rProfileOptions["-acodec"] == $rCodec)) { echo "selected "; } ?>value="<?=$rCodec?>"><?=$rCodecName?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
